...
)
{
	...
	if (method == TXAGC) {
		...
		if (rf_path == RF_PATH_A) {
			PHY_SetTxPowerIndexByRateSection(adapter, RF_PATH_A, *p_dm->channel, CCK);
			PHY_SetTxPowerIndexByRateSection(adapter, RF_PATH_A, *p_dm->channel, OFDM);
			PHY_SetTxPowerIndexByRateSection(adapter, RF_PATH_A, *p_dm->channel, HT_MCS0_MCS7);
			PHY_SetTxPowerIndexByRateSection(adapter, RF_PATH_A, *p_dm->channel, HT_MCS8_MCS15);
		} else {
			PHY_SetTxPowerIndexByRateSection(adapter, RF_PATH_B, *p_dm->channel, CCK);
			PHY_SetTxPowerIndexByRateSection(adapter, RF_PATH_B, *p_dm->channel, OFDM);
			PHY_SetTxPowerIndexByRateSection(adapter, RF_PATH_B, *p_dm->channel, HT_MCS0_MCS7);
			PHY_SetTxPowerIndexByRateSection(adapter, RF_PATH_B, *p_dm->channel, HT_MCS8_MCS15);
		}
#else
