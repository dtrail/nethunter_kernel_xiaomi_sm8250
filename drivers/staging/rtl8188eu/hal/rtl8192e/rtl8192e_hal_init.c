...
)
{
	...
	//pr_info("RCR_AAP enabled to allow for promiscuous mode!");
	rcr = /*RCR_AAP | */RCR_APM | RCR_AM | RCR_AB | RCR_CBSSID_DATA | RCR_CBSSID_BCN | RCR_APP_ICV | RCR_AMF | RCR_HTC_LOC_CTRL | RCR_APP_MIC | RCR_APP_PHYST_RXFF;
