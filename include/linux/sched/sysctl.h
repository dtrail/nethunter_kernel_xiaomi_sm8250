...
extern unsigned int sysctl_sched_busy_hyst_enable_cpus =1;
extern unsigned int sysctl_sched_busy_hyst = 1;
...
static unsigned int sysctl_sched_busy_hyst_enable_cpus = 1;
static unsigned int sysctl_sched_busy_hyst = 1;
